...
public class A3  extends JFrame {
	...
	class TreeNodeSelectionListener  implements TreeSelectionListener {
		public void valueChanged(TreeSelectionEvent e) {
			...
			if (selectedComponent != null && selectedComponent instanceof NestedShape) {
	...
	class AddListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			Object selectedComponent = tree.getLastSelectedPathComponent();
			if (selectedComponent != null && selectedComponent instanceof NestedShape) {
				panel.model.addShapeNode((NestedShape) selectedComponent);
			} else if (selectedComponent != null && selectedComponent instanceof NestedShape == false) {
	...
	class RemoveListener implements ActionListener {
		public void actionPerformed( ActionEvent e) {
			Object selectedComponent = tree.getLastSelectedPathComponent();
			if (selectedComponent != null && selectedComponent != tree.getModel().getRoot()){
				panel.model.removeNodeFromParent((Shape)selectedComponent);
			} else if (selectedComponent != null && selectedComponent == tree.getModel().getRoot()){
